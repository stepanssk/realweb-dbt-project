...
--комбинируем собранные выше данные по каналам
...
--добавим в комбинированную таблицу выше данные по установкам, собранные в самом начале
...
--финальный вывод с фильтром по платформам
