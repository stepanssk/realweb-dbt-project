...
select    
    ...
    t.costs
from intersection i
 join red_stg_mytarget t on (i.date=t.date) and (i.campaign_name=t.campaign_name) and (i.adset_name=t.adset_name)
...
select    
    ...
    0 installs, 
    t.costs
from exception_mt et
    join red_stg_mytarget t on (et.date=t.date) and (et.campaign_name=t.campaign_name) and (et.adset_name=t.adset_name)
