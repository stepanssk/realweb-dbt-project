...
7. В системе управления версиями (CTRL + SHIFT + G) зафиксируйте ваши изменения (символ ☑️) ,  а  потом  нажмите на символ справа  (CREATE PULL REQUEST). Так ваши изменения попадут на код-ревью. Если все хорошо, то мы добавим их в ветку `main` :)
